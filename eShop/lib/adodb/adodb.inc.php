 ...
 */
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
	...
	public $maxblobsize = 256000; 	/// maximum size of blobs or large text fields -- some databases die otherwise like foxpro
	...
	public $charSet=false; 		/// character set to use - only for interbase
