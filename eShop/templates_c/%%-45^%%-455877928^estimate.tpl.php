...
<tr>
	...
	<td style="text-align: right;background-color: #999999;border-style: solid;border-color: #000000;border-width: 1px 1px 1px 1px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['totalTtc']/1.196)) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
 <?php echo $this->_tpl_vars['currency']; ?>
</td>
</tr>
<tr>
