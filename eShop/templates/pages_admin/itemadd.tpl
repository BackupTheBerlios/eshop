<form action="index.php?module=mod_items&action=save" method="post" enctype="multipart/form-data" name="registration">
<table width="600" border="0">
  <tr>
    <td colspan="2"><div align="center">Ajout d'un article</div></td>
  </tr>
  {if $error}
  <tr>
  ...
  <tr>
    <td colspan="2"><div align="center">
      <input class="submit" type="submit" name="Submit" value="Créer" />
    </div></td>
  </tr>
</table>
</form>